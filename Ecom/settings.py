...
SECRET_KEY = 'django-insecure-p3+5&v!45)hzmi=ah*r8=*lh%qq=g_1dj02jwzga=%4s)cr1z%'
...
# Database
if os.getenv("DATABASE_URL"):  # Railway or any external Postgres
    DATABASES = {
...
else:  # Local development fallback (SQLite)
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
            'NAME': BASE_DIR / "db.sqlite3",
